...
2. **Anti-inbreeding catches sustained near-duplicate poisoning.** If an attacker repeats the contamination across multiple sessions to drive graduation, the explanation-overlap check rejects citations whose content is too similar to the graduation claim — sustained poisoning that just repeats itself doesn't accumulate evidence weight.
