...
- **Publish form:** spore-424 (TOKEN3, twine ≥ 7). After the upload: tag `v0.9.12` at the stamp commit, push the tag, bump to `0.9.13.dev0` at every stamp site (`git grep -n '0\.9\.12"'`), then do spore-424's three-step verify.
